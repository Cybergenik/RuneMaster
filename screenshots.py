...
class Screenshots:
    ...
    def runes(self):
        ...
        self.driver.find_element_by_xpath('//*[@id="perks-app"]/div').screenshot('./Dyslexicon/images/vape'+seed+'.png')
        self.driver.close()
        return seed

    def build(self):
        seed = str(random.randint(0,99999))
        self.driver.find_element_by_xpath('/html/body/div/div[2]/div[3]/div[2]/div[2]/div/div/div[2]/div[1]/div[1]').screenshot('./Dyslexicon/images/vape'+seed+'.png')
        self.driver.close()
        return seed

    def skills(self):
        seed = str(random.randint(0,99999))
        self.driver.find_element_by_xpath('/html/body/div/div[2]/div[3]/div[2]/div[2]/div/div/div[1]/div[1]').screenshot('./Dyslexicon/images/vape'+seed+'.png')
        self.driver.close()
        return seed
    ...
    def stats(self):
        ...
        seed = str(random.randint(0,99999))
        self.driver.find_element_by_xpath('/html/body/div/div[2]/div[3]/div[2]/div[1]/div/div/div[2]').screenshot('./Dyslexicon/images/vape'+seed+'.png')
        self.driver.close()
        return seed
        
    def sums(self):
        seed = str(random.randint(0,99999))
        self.driver.find_element_by_xpath('/html/body/div/div[2]/div[3]/div[2]/div[1]/div/div/div[4]/div[7]').screenshot('./Dyslexicon/images/vape'+seed+'.png')
        self.driver.close()
        return seed
    ...
    def kill_seed(self, seed):
        ...
        '''
        if os.path.exists("./Dyslexicon/images/vape"+seed+".png"):
           os.remove("./Dyslexicon/images/vape"+seed+".png")
        else:
